...
PCT=2
MOD="diverse"
CORPUS="data/biology/corpus/subsets/pubmed_vocab/pubmed_corpus_diverse_interdoc_linnaeus_train_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/data_select/$FINE_TUNE_DATASET/pubmed_${PCT}pct_${MOD}_pubmed_vocab_all_interdoc"
MAX_STEPS="128194"
CONTINUE="TRUE"
