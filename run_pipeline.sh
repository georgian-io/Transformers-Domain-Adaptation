...
PCT=25
MOD="sim_div"
CORPUS="data/biology/corpus/subsets/$FINE_TUNE_DATASET/pubmed_vocab/pubmed_corpus_most_sim_div_all_BC2GM_train_${PCT}pct_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/data_select/$FINE_TUNE_DATASET/pubmed_${PCT}pct_${MOD}_pubmed_vocab_all"
MAX_STEPS="128194"
CONTINUE="TRUE"
