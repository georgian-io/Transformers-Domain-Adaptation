...
PCT=2
MOD="similar"
CORPUS="data/biology/corpus/subsets/BC2GM/pubmed_vocab/pubmed_corpus_similar_all_${FINE_TUNE_DATASET}_train_2pct_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/vocab_aug/$FINE_TUNE_DATASET/pubmed_vocab_augmented_${PCT}pct_similar"
MAX_STEPS="128194"
CONTINUE="TRUE"
