...
PCT=10
CORPUS="data/biology/corpus/subsets/BC2GM/pubmed_vocab/pubmed_corpus_most_sim_div_all_BC2GM_train_${PCT}pct_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/vocab_aug/$FINE_TUNE_DATASET/pubmed_vocab_augmented_${PCT}pct_sim_div"
MAX_STEPS="128194"
CONTINUE="TRUE"
