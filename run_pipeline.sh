...
PCT=2
MOD="diverse"
CORPUS="data/biology/corpus/subsets/pubmed_vocab/pubmed_corpus_least_diverse_all_linnaeus_train_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/$FINE_TUNE_DATASET/pubmed_${PCT}pct_least_${MOD}_pubmed_vocab_all"
MAX_STEPS="128194"
CONTINUE="TRUE"
