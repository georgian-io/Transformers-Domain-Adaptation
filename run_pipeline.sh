...
PCT=2
CORPUS="data/biology/corpus/subsets/pubmed_vocab/pubmed_corpus_similar_all_linnaeus_train_2pct_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/intratask_transfer/$FINE_TUNE_DATASET/BC2GM_DS-x-linnaeus-${PCT}pct"
MAX_STEPS="128194"
CONTINUE="TRUE"
