...
PCT=2
MOD="similar"
CORPUS="data/biology/corpus/subsets/pubmed_vocab_tfidf/pubmed_corpus_similar_all_linnaeus_train_2pct_tfidf_linear_combo_stdscl.txt"
...
OUTPUT_DIR="results/$FINE_TUNE_DATASET/pubmed_${PCT}pct_${MOD}_pubmed_vocab_tfidf_all"
MAX_STEPS="128194"
CONTINUE="TRUE"
