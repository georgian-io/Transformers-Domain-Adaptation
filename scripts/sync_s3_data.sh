...
aws s3 cp "$BUCKET/domains/biology/corpus/subsets/pubmed_corpus_${MOD}_diverse_entropy_0.02pct.txt" \
    "data/biology/corpus/subsets/pubmed_corpus_${MOD}_diverse_entropy_0.02pct.txt"
