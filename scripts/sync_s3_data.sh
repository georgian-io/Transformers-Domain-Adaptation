...
CORPUS="pubmed_corpus_least_similar_all_BC2GM_train_2pct_linear_combo_stdscl.txt"
mkdir -p $DATA_DIR
mkdir -p $RESULTS_DIR
...
aws s3 cp "$BUCKET/domains/biology/corpus/subsets/BC2GM/pubmed_vocab/$CORPUS" \
    "data/biology/corpus/subsets/BC2GM/pubmed_vocab/$CORPUS"
